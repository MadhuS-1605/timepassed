    ...
    if ('wakeLock' in navigator) {
      if (wakeLock) {
        ...
        try {
          ...
          alert("Couldn't activate Always-On mode. Battery saver might be blocking it.");
        }
      }
    } else {
    ...
    <ThemeProvider theme={theme}>
      ...
      <div className={`page-content ${mode === 'light' ? 'light-mode' : ''}`}>
        <div className="year-progress card" style={{ fontSize: "2rem" }}>
          <h1 className="glow-text" style={{ marginBottom: '0px', marginTop: '0px' }}>{now.getFullYear()}</h1>
          <div
            style={{
              color: mode === 'dark' ? "#94a3b8" : "#475569",
              letterSpacing: "0.1em",
